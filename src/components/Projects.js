...
var projects = [
  ...
  },
  {
    ...
    "tags": ['Artificial Intelligence', 'Naive Bayes', 'Neural Networks', 'Random Forest', 'Algorithms', 'Classification', 'scikit-learn']
  },
  {
    ...
    'kaggle': '',
    "textShort": "The website that you are on right now! I created this website using a combination of React, React-Bootstrap, Bootstrap, HTML, and CSS.",
    "tags": ['React', 'JavaScript', 'Web Development', 'React Bootstrap', 'HTML', 'CSS']
  },
  {
    ...
    'kaggle': '',
    "textShort": "An Android app that generates high-intensity interval workouts based on the user specified equipment and exercises. This app was created using Java and XML in AndroidStudio (still in progress).",
